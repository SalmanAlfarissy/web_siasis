            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="body">
                    <div class="button-demo">
                        <a href="{{ route('admin.staf.createkelas') }}" class="btn bg-red waves-effect">Add Kelas</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                {{-- <a type="button" class="btn bg-deep-orange btn-circle waves-effect waves-circle waves-float">
                                                    ...
                                                    <form method="POST" novalidate="novalidate" action="{{ route('admin.staf.deletekelas', $item->id) }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}

                                                        <a href="{{ route('admin.staf.editkelas', $item->id) }}" class="btn bg-light-blue btn-circle waves-effect waves-circle waves-float">
