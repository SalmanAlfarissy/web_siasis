                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                {{-- <a type="button" class="btn bg-deep-orange btn-circle waves-effect waves-circle waves-float">
                                                    ...
                                                    <form method="POST" novalidate="novalidate" action="{{ route('admin.staf.delete', $item->id) }}">
                                                        @csrf
                                                        {{ method_field('DELETE') }}

                                                        <a href="{{ route('admin.staf.edit', $item->id) }}" class="btn bg-light-blue btn-circle waves-effect waves-circle waves-float">
