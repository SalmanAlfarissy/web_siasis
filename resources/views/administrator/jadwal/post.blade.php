    ...
    <div class="container-fluid">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="body">
                    <div class="button-demo">
                        <a href="{{ route('admin.staf.jadwal') }}" class="btn bg-red waves-effect">Daftar Jadwal Pelajaran</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>ADD JADWAL PELAJARAN</h2>
                    </div>
                    <div class="body">
                        <form id="form_validation" method="POST" novalidate="novalidate" action="{{ route('admin.staf.storejadwal') }}" enctype="multipart/form-data">
                            @csrf

                            <div class="row clearfix">
                                <div class="col-sm-12 @error('staf_id') focused error @enderror">
                                    <select class="form-control show-tick" name="staf_id">
                                        <option value="">-- Please select guru --</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12 @error('matpel_id') focused error @enderror">
                                    <select class="form-control show-tick" name="matpel_id">
                                        <option value="">-- Please select mata pelajaran --</option>
                            ...
                            <div class="form-group form-float">
                                <div class="form-line @error('kkm') focused error @enderror">
                                    <input type="number" class="form-control" name="kkm" required value="{{ old('kkm') }}">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12 @error('hari') focused error @enderror">
                                    <select class="form-control show-tick" name="hari">
                                        <option value="">-- Please select hari --</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line @error('jadwal_masuk') focused error @enderror">
                                                <input type="text" class="form-control time24" name="jadwal_masuk" placeholder="23:59">
                                            </div>
                                            @error('jadwal_masuk')
                                                <label class="error">{{ $message }}</label>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line @error('jadwal_keluar') focused error @enderror">
                                                <input type="text" class="form-control time24" name="jadwal_keluar" placeholder="23:59">
                                            </div>
                                            @error('jadwal_keluar')
                                                <label class="error">{{ $message }}</label>
                                            @enderror
