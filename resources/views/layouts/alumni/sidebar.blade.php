<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <form action="{{ route('siswa.logout') }}" method="get">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{ asset('gambar/siswa/'.session('alumni.foto_siswa')) }}" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ session('alumni.nama') }}</div>
                    <div class="email">{{ session('alumni.email') }}</div>
                    <div class="btn-group user-helper-dropdown">
                        <i class="material-icons" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('alumni.profile',session('alumni.id')) }}"><i class="material-icons">person</i>Profile</a></li>
